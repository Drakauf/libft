...
#    Updated: 2019/03/07 16:27:34 by shthevak    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
SSRC_NAME = ft_bzero.c ft_isalpha.c ft_isascii.c ft_itoa.c ft_itoa_base.c\
			...
			ft_putstr.c ft_putstr_fd.c ft_putstr_tab.c ft_strcat.c ft_strcmp.c\
			ft_strcpy.c ft_strdel.c ft_strdup.c ft_strequ.c ft_strjoin.c\
			ft_strjoin_free.c ft_strjoin_insert.c ft_strlen.c
